...
# populate movies
m1 = Movies(rating=10, title="Boyhood", director="Richard Linklater")
m2 = Movies(rating=8, title="Before Sunset", director="Richard Linklater")
m3 = Movies(rating=9, title="Waking Life", director="Richard Linklater")
